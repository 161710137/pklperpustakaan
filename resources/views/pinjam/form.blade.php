                ...
                {{csrf_field()}} {{ method_field('POST') }}
                  ...
                  <div class="modal-body">                     
                     ...
                     <div class="form-group">
                        <label>Nama Pinjam Kembali  :</label>
                        <input type="text" name="nopjkb" id="nopjkb" class="form-control" placeholder="MasukanTahun Terbit Buku" />
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="tgl_pjm" id="tgl_pjm" class="form-control"  value="{{ carbon\carbon::today()->toDateString() }}" readonly placeholder="Masukan Nama Pengarang Buku" />
                        <span class="help-block has-error tgl_pjm_error"></span>
                     </div>
                     <div class="form-group">
                        <label>Tanggal Harus Kembali :</label>
                        <input type="text" name="tgl_hrs_kbl" id="tgl_hrs_kbl" class="form-control" placeholder="Masukan Tanggal Harus Kembali Buku" />
